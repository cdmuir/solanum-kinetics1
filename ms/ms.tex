...
\tightlist
\item
  Partition variance in tau and lambda
\item
...
The phylogenetic variance component was significantly higher than that
of other response variables Figure~\ref{fig-variance}. add table to show
CIs in supplement?
