...
described in (11). The idea to use \gsw response curve to test
...
package \textbf{loo} version 2.8.0 (13) to calculate LOOIC values. We
...
phylogenetic relationships (14, 15). The between- and within-individual
...
component and is estimated following (14); (15) as:
